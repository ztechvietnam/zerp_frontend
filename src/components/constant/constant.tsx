...
export const dataUsers = Array.from({ length: 46 }).map((_, i) => ({
  ...
  department: (i % 11 == 1 || i % 11 == 2 ? 3 : i % 11).toString(),
}));
...
export const dataDepartments: DepartmentEntity[] = [
  {
    id: "1",
    name: "Đa khoa quốc tế",
    code: "DKQT",
    address: "124 Nguyễn Đức Cảnh",
    created: "2024-09-05T08:00:00Z",
    createdBy: "admin",
    status: true,
  },
  {
    ...
    name: "Tổng công ty",
    code: "TCT",
    address: "124 Nguyễn Đức Cảnh, Cát Dài, Lê Chân, Hải Phòng",
    created: "2024-09-05T08:00:00Z",
    createdBy: "admin",
    status: true,
  },
