...
const NewsCategories = () => {
  ...
  const newsCategoryFormRef = useRef<NewsCategoryFormRef>(null);
        ...
        <span
          ...
          onClick={() => {
            if (record.item.parent_category_id) {
              newsCategoryFormRef.current?.show(record.item);
            }
          }}
        >
          {record.item.name}
        ...
        <div>
          ...
          <Breadcrumb
            items={[
              ...
              {
                title: <Tag color="#108ee9">Danh mục tin tức</Tag>,
              },
            ]}
          />
        </div>
      ...
      toolbarRight={
        <div>
          <Button
            ...
            onClick={() => {
              newsCategoryFormRef.current?.show();
            }}
          >
            Thêm danh mục
          </Button>
